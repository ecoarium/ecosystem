...
<coverage>
	<packages>
		<package>
			<classes>
				<class name="com.fake.Application" filename="com/fake/Application.java" line-rate="0.2" branch-rate="1.0" complexity="1.0">
					<lines>
        ...
        assertEquals('''Project fake, Class com.fake.fakeApplication failed check. Line coverage rate of 20% is below 80%.
''', buffer.toString())
    }
...
<thresholds>
  <threshold class="com.fake.fakeApplication" branchcount="0" branchsexecuted="0" branchrate="1.0" linecount="10" linesexecuted="4" linerate="0.4"/>
</thresholds>''')
...
<coverage>
	<packages>
		<package>
			<classes>
				<class name="com.fake.fakeApplication" filename="com/fake/fakeApplication.java" line-rate="0.7" branch-rate="1.0" complexity="1.0">
					<lines>
						<line number="1" hits="0" branch="false"/>
						<line number="2" hits="0" branch="false"/>
						<line number="3" hits="0" branch="false"/>
        ...
        def threshold = thresholds.threshold.find { it.@class == 'com.fake.fakeApplication' }
    ...
    public void checkShouldFailCauseNewCodeLoweredCoverageRateBelowExistingThreshold() {
        ...
        def thresholds = new XmlParser().parseText('''<?xml version="1.0" encoding="UTF-8"?>
<thresholds>
  <threshold class="com.fake.fakeApplication" branchcount="0" branchsexecuted="0" branchrate="1.0" linecount="10" linesexecuted="0" linerate="0.0"/>
</thresholds>''')
...
<coverage>
	<packages>
		<package>
			<classes>
				<class name="com.fake.fakeApplication" filename="com/fake/fakeApplication.java" line-rate="0.2" branch-rate="1.0" complexity="1.0">
					<lines>
						<line number="1" hits="0" branch="false"/>
						<line number="2" hits="0" branch="false"/>
						<line number="3" hits="0" branch="false"/>
        ...
        assertEquals('''Project fake, Class com.fake.fakeApplication failed check. Line coverage rate of 20% is below 40%.
''', buffer.toString())
    }
...
<coverage>
	<packages>
		<package>
			<classes>
				<class name="com.fake.fakeApplication" filename="com/fake/fakeApplication.java" line-rate="0.4" branch-rate="1.0" complexity="1.0">
					<lines>
						<line number="1" hits="0" branch="false"/>
						<line number="2" hits="0" branch="false"/>
						<line number="3" hits="0" branch="false"/>
    ...
    public void checkShouldFailWithRemovedCode() {
        ...
        def thresholds = new XmlParser().parseText('''<?xml version="1.0" encoding="UTF-8"?>
<thresholds>
  <threshold class="com.fake.fakeApplication" branchcount="0" branchsexecuted="0" branchrate="1.0" linecount="100" linesexecuted="40" linerate="0.4"/>
</thresholds>''')
...
<coverage>
	<packages>
        ...
        assertEquals('''Project fake, Class com.fake.fakeApplication failed check. Line coverage rate of 40% is below 80%.
''', buffer.toString())
    }
